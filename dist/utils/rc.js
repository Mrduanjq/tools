...
const exits = (0, _util.promisify)(_fs2.default.exists); // 配置文件 .mrduanrc文件的增删改查
...
const set = exports.set = async (key, value) => {
  ...
  if (exit) {
    ...
    opts = (0, _ini.decode)(opts);
    if (!key) {
      console.log(_chalk2.default.red(_chalk2.default.bold("错误：")), _chalk2.default.red("key值是必须的"));
      return;
    }
    if (!value) {
      console.log(_chalk2.default.red(_chalk2.default.bold("错误：")), _chalk2.default.red("value值是必须的"));
      return;
    }
